...
| [**Mental Health in Tech Survey Analysis** (Work in Progress...)](https://github.com/zJayTech/Mental-Health-in-Tech-Survey-Analysis) | R | Analyzing mental health trends and support in the tech industry using a Kaggle survey dataset, visualized with R and ggplot2 |
